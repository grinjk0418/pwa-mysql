-- DB 생성
CREATE DATABASE mydb; -- MySQL에서 명은 전부 소문자로...
...
-- AUTO_INCREMENT 값 변경
-- ----------------------
ALTER TABLE users AUTO_INCREMENT = 1; -- AUTO_INCREMENT값 초기화(안건드는게 좋음)
...
-- 테이블의 모든 데이터 삭제
-- -------------------------
TRUNCATE TABLE salaries; -- 이력도 안남기고 삭제,빠르게 삭제됨(되도록 안쓰는게 좋음)
